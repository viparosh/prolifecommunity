  ...
  return (
    <>
      <div className="flex items-center justify-between">
        ...
        >
          <option value={3}>Upcoming Visit (3 days prior)</option>
          <option value={5}>Upcoming Visit (5 days prior)</option>
          <option value={7}>Upcoming Visit (7 days prior)</option>
      ...
      <div className="mb-20 flex flex-row justify-between items-center w-full">
